...
$pdf->Cell(0,6,'PEMERINTAH KOTA PROBOLINGGO',$border,1,'C');
$pdf->SetFont('Arial','B',16);
$pdf->Cell(0,6,'DEWAN PERWAKILAN RAKYAT DAERAH (DPR)',$border,1,'C');
$pdf->SetFont('Arial','B',9);
$pdf->Cell(0,4,'Jl. Suroyo No.27, Tisnonegaran, Kec. Kanigaran, Kota Probolinggo, Jawa Timur',$border,1,'C');
$pdf->Cell(0,4,'Telepon: (0335) 433326 Website : www.dprdkotaprobolinggo.go.id',$border,1,'C');
$pdf->SetFont('Arial','B',11);
$pdf->Cell(0,6,'KOTA PROBOLINGGO',$border,1,'C');
$pdf->Cell(0,6,'Kode Pos 67217               ',$border,1,'R');
$pdf->Cell(0,6,'',$border,1,'C');
$pdf->SetFont('Arial','BU',15);
$pdf->Cell(0,6,'SURAT PERINTAH TUGAS',$border,1,'C');
$pdf->SetFont('Arial','',10);
$pdf->Cell(0,10,'Nomor : '.$sppd->no_surat.' / 25.DPR / '.date('m',strtotime($sppd->tgl_surat)).' / '.$sppd->tahun_surat,$border,1,'C');
...
$pdf->Cell(85,5,'',$border,0,'L');
$pdf->Cell(105,5,'DEWAN PERWAKILAN RAKYAT DAERAH',$border,1,'C');
